export const seoFaq = [
  ...
  },
  {
    ...
    answer:
      'S3Panel supports Amazon S3, Cloudflare R2, MinIO, Wasabi, DigitalOcean Spaces, Backblaze B2, Hetzner Object Storage, Scaleway, Akamai Object Storage, and custom S3-compatible endpoints.',
  },
  {
    question: 'Does S3Panel store my bucket files?',
    answer:
      'No. Customer object bytes remain in the connected storage provider. S3Panel acts as a control surface for metadata, search, and file operations.',
  },
  {
    question: 'Can S3Panel search large buckets?',
    answer:
  ...
  {
    question: 'Should I send S3 secret keys to support?',
    answer:
      'No. Never send S3 secret keys, API tokens, or bucket credentials by email or contact form. If credentials may be exposed, rotate them in your storage provider dashboard.',
  },
  {
